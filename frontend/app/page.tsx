          ...
          <div className="flex flex-col items-center justify-center space-y-8 text-center">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-6xl md:text-7xl">
                Tutorial - ECAN: Economic Attention Network
              </h1>
              <p className="max-w-[800px] mx-auto text-lg text-muted-foreground md:text-xl">
                Learn the core concepts of ECAN, attention allocation, Mind Agents, and knowledge management in cognitive systems using Hyperon .
              </p>
            </div>
